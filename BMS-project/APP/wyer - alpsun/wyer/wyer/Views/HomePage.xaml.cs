    ...
    public partial class HomePage : ContentPage
    {
        ...
        public HomePage()
        {
            ...
            if (Preferences.Get("UserID", "")!="")
            {
                ...
                Account= Preferences.Get("UserID", "");
            }
            else   //如果不記憶帳密
            {
                DeviceSelect.name = "";// TempData.T_name;
                DeviceSelect.mac = "";
                DeviceSelect.batteryname = "";
            ...
            else
            {
                ...
                nodata_txt.Text = "Please go to List page to add device and selecting one device.";
            }
        ...
        private void OnPickerSelectedIndexChanged(object sender, EventArgs args)
        {
            ...
            {
                TempData.T_name= name;
                TempData.T_mac = mac;
                TempData.T_battery = batteryname;
            }
        ...
        private async void Get_data()
        {
            ...
            if (mac != "") //有初值或是有選擇devoice時, 否則為剛login或是新裝機者
            {
                ...
                {
                    Console.WriteLine(ex.Message);
                    if (ex.Message.IndexOf("Failed to connect to") != -1 )
                    {
