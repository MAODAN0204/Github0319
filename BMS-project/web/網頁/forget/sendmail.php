...
if($data!="")	
{
  $member=crypt($data,'ws');						//encode memberid to send mail
...
try {
    ...
    $mail->Subject = 'Reset your password';
        ...
        $body=$body.'<p> <a href="https://118.163.50.93/change_password/?mail='.$id.'&id='.$member.'" > http://www.wyer.com.tw/change_password/</a></p><h4 style="margin-top:1em;">';
