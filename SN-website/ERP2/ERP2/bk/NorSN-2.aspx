<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NorSN-2.aspx.cs" Inherits="ERP2.NorSN" %>
                ...
                <div class="col-6 ">
                    ...
                    <div class="col-12" id="SearchData" runat="server"> <!--Data Search area-->
                        ...
                        <div class="row pt3" runat="server" id="psmodisection">
                            <div class="col-12"><h4 class="text-center font-weight-bolder pt-2">修改資料</h></div>
                            <dir class="col-3">超始序號：<asp:Label runat="server" ID="Label1"></asp:Label></dir>
                            <dir class="col-3">超始序號：<asp:Label runat="server" ID="Label2"></asp:Label></dir>
                            <dir class="col-3">日期：<asp:Label runat="server" ID="Label4"></asp:Label></dir>
                            <dir class="col-3">建立人員<asp:Label runat="server" ID="Label6"></asp:Label></dir>
                            <dir class="col-6">備註：<asp:TextBox runat="server" ID="s2" class="form-control"></asp:TextBox></dir>
                            <dir class="col-3 text-center" ><asp:Button runat="server" class="btn btn-danger" OnClick="ModifyBtn" Text="Save"/></dir>
                            <dir class="col-3 text-center"><asp:Button runat="server" class="btn btn-secondary" OnClick="CancelModify" Text="Save"/></dir>
                            <div class="col-12"><hr /></div>
                        </div>
                        <div class="row"> <!--Search out Data-->
                            <div class="col-12">
                                <div class="border-box scroll-auto">
                                    <!--asp:Table ID="Table1" runat="server" class="table" CssClass="table">
                                        <asp:TableHeaderRow CssClass="table-danger">
                                            <asp:TableCell CssClass="text-center"><button id="ModifyBtn1" class="btn btn-dark"  />修改</button></asp:TableCell>
                                            <asp:TableCell>起始序號</asp:TableCell>
                                            <asp:TableCell>結束序號</asp:TableCell>
                                            <asp:TableCell>組數</asp:TableCell>
                                            <asp:TableCell>日期</asp:TableCell>
                                            <asp:TableCell>人員</asp:TableCell>
                                        </asp:TableHeaderRow>
                                    ...
                                    <table id="Search-data" class="table">
                                        ...
                                        <tr class="table-danger" >
                                            <th scope="col" class="text-center"><button id="ModifyBtn2" class="btn btn-dark" >修改</button></th>
                                            <th scope="col">起始序號</th>
                                            <th scope="col">起始序號</th>
                                            <th scope="col">組數</th>
                                            <th scope="col">日期</th>
       ...
       <div id="msgbox" runat="server">
           ...
           <div class="QuestBox">
               ...
               <div class="row pt-2 pb-2">
                   ...
                   <div class="col-6 text-center"><asp:Button ID="Button2" runat="server" Text="修改" class="btn ml-2 btn-lg btn-info" onclick="Modibtn_Click"/></div>
               </div>
           </div>
       </div>
     </form>
